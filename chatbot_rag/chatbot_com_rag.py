...
from chatbot_rag.azure_client_helper import get_client
from chatbot_rag.common import get_path_projeto
from chatbot_rag.vector_store_helper import get_vectorstore_as_retriver
